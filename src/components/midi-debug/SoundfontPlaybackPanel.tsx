...
import { parseMidiInstruments, InstrumentInfo, getMidiInstrumentName } from '../../utils/midiParser';
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        {instrument.name !== getMidiInstrumentName(instrument.instrument, instrument.channel) && (
                          <div className="text-white/40 text-xs mt-1">
                            GM Category: {getMidiInstrumentName(instrument.instrument, instrument.channel)}
                          </div>
                        )}
                      </div>
                    </div>
